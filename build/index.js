...
class Like {
  ...
  ourClickDispatcher(e) {
    var currentLikedBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest(".like-box");
  ...
  deleteLike(currentLikedBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      url: universityData.root_url + '/wp-json/university/v1/manageLike',
      data: {
        'like': currentLikedBox.attr('data-like')
      },
      type: 'DELETE',
      success: response => {
...
class MyNotes {
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      error: response => {
        if (response.responseText == "You have exeeded your note limit") {
...
class Search {
  ...
  } // 3.This is where our methods will live
  ...
  getResults() {
                ...
                <div class = "row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.professors.map(item => `
                            ...
                            <a class="professor-card"${item.permalink}">
                    ...
                    <div class="one-third">
                        ...
                        ${results.events.length ? '' : `<p>No events match that search. <a href ="${universityData.root_url}/events">View all campuses</a></p>`}
    ...
    /*   This is for when we did not have custom REST API DATA
    $.when(
